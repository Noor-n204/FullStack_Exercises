let users=[
    ...
    let newArr=users.map(u => { return { email: u.email, companyName: u.company.name } })



    //Exrcise 2---------------------------------------------------------------------------------------------------

    let zipStartWith5 = users.filter(u => u.address.zipcode[0] =="5")


    //Exercise 3---------------------------------------------------------------------------------------------------
    let zipStartWith5ID = users.filter(u => u.address.zipcode[0] =="5").map(u => u.id)



    //Exercise 4-------------------------------------------------------------------

    let namesArr=users.filter(u => u.name.startsWith('C')).map(u => u.name)
    ...
    //Exercise 5--------------------------------------------------------------------------------------------
    users.every(u => u.city=="South Christy")
    ...
    findBySuite('Apt. 950').company.name




    //Exercise 7--------------------------------------------------------------------------------------------------------------
    const print=function(user){
